...
const productsContainerTwo = document.querySelector('.products-container');

const fetchPersonalData = function() {
    ...
    request.addEventListener('load', function() {
        ...
        for (let i = 0; i < allProducts.length; i++){
            if(allProducts[i].category === "fragrances" || allProducts[i].category === "skincare"){
                ...
                console.log(main);
                productsContainerTwo.insertAdjacentHTML('beforeend', main);
            }
        }
    })
}
