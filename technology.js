...
const productsContainerOne = document.querySelector('.products-container');

const fetchTechnologyData = function() {
    ...
    request.addEventListener('load', function() {
        ...
        for (let i = 0; i < allProducts.length; i++){
            if(allProducts[i].category === "smartphones" || allProducts[i].category === "laptops"){
                ...
                console.log(main);
                productsContainerOne.insertAdjacentHTML('beforeend', main);
            }
        }
    })
}
