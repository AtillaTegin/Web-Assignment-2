...
const productsContainerThree = document.querySelector('.products-container');

const fetchHouseData = function() {
    ...
    request.addEventListener('load', function() {
        ...
        for (let i = 0; i < allProducts.length; i++){
            if(allProducts[i].category === "groceries" || allProducts[i].category === "home-decoration"){
                ...
                productsContainerThree.insertAdjacentHTML('beforeend', main);
            }
        }
    })
}
